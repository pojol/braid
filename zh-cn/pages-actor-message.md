...
actor.OnEvent(events.EvUserUseItem, func(ctx core.ActorContext) core.IChain {
...
actor.OnTimer(dueTime, interval, callback, args)
```
...
```go
a.Sub(events.EvChatMessageStore, a.Id, func (ctx core.ActorContext) core.IChain {
	return &actor.DefaultChain{
		Handler : func(mw *msg.Wrapper) error {
			// todo
			return nil
